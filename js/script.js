  ...
  if (emailId == "") {
    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR)
        {
          ...
          var URL = BASE_URL_FIREBASE_DB+"users.json?orderBy=\"email\"&equalTo=\"" + userDetails.email + "\"&print=pretty";
...
$('#submitt').click(function () {
  ...
  if (practiceName == "") {
    ...
    var formData = {name:userDetails.displayName,practiceName:practiceName, email:userDetails.email,  createdDate: getCurrentDate()}; //Array 
